...
elimination method. It started with all candidate variables and then
removed the predictor with the p-value higher than then criterion. The
model repeated the process until no other variables can be removed
...
<img src="p8105_hw6_hz2710_files/figure-gfm/unnamed-chunk-3-1.png" width="90%" />

The residuals bounce around 0 and form a horizontal band around 0 but
with some outliers on small fitted values.
...
<img src="p8105_hw6_hz2710_files/figure-gfm/unnamed-chunk-7-1.png" width="90%" />

We can see that in cross validation model1 got the lowest rmse and
model2 got the highest rmse. Model1 had the best performance among these
three models while the model2 predicted the worse result.
...
```
    ...
    ##    <chr>     <dbl>     <dbl> <dbl>    <dbl>
    ##  1 0001      0.919      7.07  1.04     2.00
    ##  2 0002      0.915      7.17  1.04     2.01
    ##  3 0003      0.899      7.41  1.03     2.03
    ##  4 0004      0.906      6.88  1.06     1.98
    ##  5 0005      0.903      7.37  1.03     2.03
    ##  6 0006      0.899      7.63  1.02     2.05
    ##  7 0007      0.909      6.72  1.08     1.98
    ##  8 0008      0.903      7.63  1.02     2.05
    ##  9 0009      0.914      7.39  1.03     2.03
    ## 10 0010      0.919      7.09  1.04     2.00
...
<img src="p8105_hw6_hz2710_files/figure-gfm/unnamed-chunk-10-1.png" width="90%" />

The r̂2 followed a normal distribution and had a well bell shaped with a
mean value around 0.91. It shows that the model had a good performance.
...
<img src="p8105_hw6_hz2710_files/figure-gfm/unnamed-chunk-11-1.png" width="90%" />

The log(β̂0 ∗β1) followed a normal distribution and had a bell shaped
with a mean value around 2.02.

## 2.5% and 97.5% quantiles for ^2:
...
The 95% confidence interval for r̂2 is (0.8941629, 0.9271524).
...
The 95% confidence interval for log(β̂0 ∗β1) is (1.9663813, 2.0581256).
